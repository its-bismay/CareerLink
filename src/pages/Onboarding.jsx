  ...
  return (
    <div className='flex flex-col items-center justify-center mt-32'>
      ...
      <div className='mt-16 grid grid-cols-2 gap-4 w-full md:px-40'>
        <Button variant="blue" className="h-28 text-3xl" onClick ={() => handleRoleSelection("candidate")}>Candidate</Button>
        <Button variant="destructive" className="h-28 text-3xl" onClick ={() => handleRoleSelection("recruiter")}>Recruiter</Button>
      </div>
    </div>
  )
}
